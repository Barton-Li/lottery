...
var (
	...
	cachelotteryTravelHomestayIdPrefix = "cache:lotteryTravel:homestay:id:"
)
...
func (m *defaultHomestayModel) Insert(ctx context.Context, session sqlx.Session, data *Homestay) (sql.Result, error) {
	...
	lotteryTravelHomestayIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayIdPrefix, data.Id)
	...
	}, lotteryTravelHomestayIdKey)
}

func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	lotteryTravelHomestayIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, lotteryTravelHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cachelotteryTravelHomestayIdPrefix, primary)
}
