...
var (
	...
	cachelotteryTravelHomestayCommentIdPrefix = "cache:lotteryTravel:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	lotteryTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayCommentIdPrefix, data.Id)
	...
	}, lotteryTravelHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	lotteryTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, lotteryTravelHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cachelotteryTravelHomestayCommentIdPrefix, primary)
}
