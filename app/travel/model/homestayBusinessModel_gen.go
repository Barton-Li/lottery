...
var (
	...
	cachelotteryTravelHomestayBusinessIdPrefix     = "cache:lotteryTravel:homestayBusiness:id:"
	cachelotteryTravelHomestayBusinessUserIdPrefix = "cache:lotteryTravel:homestayBusiness:userId:"
)
...
func (m *defaultHomestayBusinessModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayBusiness) (sql.Result, error) {
	...
	lotteryTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayBusinessIdPrefix, data.Id)
	lotteryTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayBusinessUserIdPrefix, data.UserId)
	...
	}, lotteryTravelHomestayBusinessIdKey, lotteryTravelHomestayBusinessUserIdKey)
}

func (m *defaultHomestayBusinessModel) FindOne(ctx context.Context, id int64) (*HomestayBusiness, error) {
	lotteryTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayBusinessIdPrefix, id)
	var resp HomestayBusiness
	err := m.QueryRowCtx(ctx, &resp, lotteryTravelHomestayBusinessIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayBusinessModel) FindOneByUserId(ctx context.Context, userId int64) (*HomestayBusiness, error) {
	lotteryTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cachelotteryTravelHomestayBusinessUserIdPrefix, userId)
	var resp HomestayBusiness
	err := m.QueryRowIndexCtx(ctx, &resp, lotteryTravelHomestayBusinessUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayBusinessModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cachelotteryTravelHomestayBusinessIdPrefix, primary)
}
