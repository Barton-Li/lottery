...
import (
	...
	"lottery/app/lottery/cmd/rpc/internal/logic"
...
func (s *LotteryServer) CheckUserCreateLottery(ctx context.Context, in *pb.CheckUserCreateLotteryReq) (*pb.CheckUserCreateLotteryResp, error) {
	l := logic.NewCheckUserCreateLotteryLogic(ctx, s.svcCtx)
	return l.CheckUserCreateLottery(in)
}

func (s *LotteryServer) CheckUserCreateLotteryAndToday(ctx context.Context, in *pb.CheckUserCreateLotteryAndTodayReq) (*pb.CheckUserCreateLotteryAndTodayResp, error) {
	l := logic.NewCheckUserCreateLotteryAndTodayLogic(ctx, s.svcCtx)
	return l.CheckUserCreateLotteryAndToday(in)
}
